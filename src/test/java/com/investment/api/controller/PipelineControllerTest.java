...
import com.investment.web.config.MenuModelAdvice;
...
@WebMvcTest(controllers = PipelineController.class, excludeFilters = {
                @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = MenuModelAdvice.class)
})
