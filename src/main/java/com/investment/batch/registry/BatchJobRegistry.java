        ...
        public List<BatchJobDefinition> getDefinitions() {
                return List.of(
                                ...
                                BatchJobDefinition.builder()
                                                ...
                                                .name("KRX 일별 시세 백필")
                                                .description("스트레스 구간 등 과거 기간 KRX 일별 시세 수집. from/to 미입력 시 오늘만 수집. 실행: Backend 내부(KrxCollectionService).")
                                                .cronExpression(null)
                                                .timeZone(TZ)
                                ...
                                BatchJobDefinition.builder()
                                                ...
                                                .name("US 일별 시세 백필")
                                                .description("스트레스 구간 등 과거 기간 US 일별 시세 수집. from/to 미입력 시 오늘만 수집. 실행: Backend → data-collector.")
                                                .cronExpression(null)
                                                .timeZone(TZ)
